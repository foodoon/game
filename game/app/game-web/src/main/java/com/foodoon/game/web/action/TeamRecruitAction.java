...
import com.foodoon.game.biz.TeamRecruitBiz;
import com.foodoon.game.dao.domain.TeamRecruitDO;
import com.foodoon.game.web.form.TeamRecruitEditForm;
import com.foodoon.game.web.form.TeamRecruitForm;
...
public class TeamRecruitAction {
    ...
    public String doCreate(HttpServletRequest request, ModelMap modelMap,@Valid TeamRecruitForm teamRecruitForm,
        ...
        if (bizResult.success) {
            return "redirect:/teamRecruit/list.vm";
        } else {
            return "common/error.vm";
        }
    ...
    @RequestMapping(value = "teamRecruit/doDelete.htm", method = RequestMethod.POST)
