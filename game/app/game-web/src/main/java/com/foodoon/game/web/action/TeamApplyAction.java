...
import com.foodoon.game.biz.TeamApplyBiz;
import com.foodoon.game.dao.domain.TeamApplyDO;
import com.foodoon.game.web.form.TeamApplyEditForm;
import com.foodoon.game.web.form.TeamApplyForm;
...
public class TeamApplyAction {
    ...
    public String doCreate(HttpServletRequest request, ModelMap modelMap,@Valid TeamApplyForm teamApplyForm,
        ...
        if (bizResult.success) {
            return "redirect:/teamApply/list.vm";
        } else {
            return "common/error.vm";
        }
    ...
    @RequestMapping(value = "teamApply/doDelete.htm", method = RequestMethod.POST)
