...
import com.foodoon.game.web.form.GoodsEditForm;
import com.foodoon.game.web.form.GoodsForm;
...
public class GoodsAction {
    ...
    @RequestMapping(value = "goods/doDelete.htm", method = RequestMethod.POST)
