...
import com.foodoon.game.biz.CourtApplyBiz;
import com.foodoon.game.dao.domain.CourtApplyDO;
import com.foodoon.game.web.form.CourtApplyEditForm;
import com.foodoon.game.web.form.CourtApplyForm;
...
public class CourtApplyAction {
    ...
    public String doCreate(HttpServletRequest request, ModelMap modelMap,@Valid CourtApplyForm courtApplyForm,
        ...
        if (bizResult.success) {
            return "redirect:/courtApply/list.vm";
        } else {
            return "common/error.vm";
        }
